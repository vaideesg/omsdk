...
class iDRAC(ClassType):
    ...
    def __init__(self, parent = None):
        ...
        self.AdminState_OS_BMC = EnumTypeField(None,AdminState_OS_BMCTypes, parent=self)
        ...
        self.ChassisInfraPower_SC_BMC = IntField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.ChassisPowerCap_SC_BMC = IntField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.ChassisServiceTagCRC_SC_BMC = IntField(None, parent=self)
        self.ChassisServiceTagLen_SC_BMC = IntField(None, parent=self)
        self.ChassisServiceTagSet_SC_BMC = IntField(None, parent=self)
        # readonly attribute
        self.ChassisServiceTag_ChassisInfo = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        self.ChassisServiceTag_SC_BMC = StringField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.DN_1_LDAPRoleGroup = StringField(None, parent=self)
        self.DN_2_LDAPRoleGroup = StringField(None, parent=self)
        self.DN_3_LDAPRoleGroup = StringField(None, parent=self)
        self.DN_4_LDAPRoleGroup = StringField(None, parent=self)
        self.DN_5_LDAPRoleGroup = StringField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.EnableSCAttributes_SC_BMC = IntField(None, parent=self)
        ...
        self.IdracPTEpIpAddr_OS_BMC = StringField(None, parent=self)
        ...
        self.LM_AUTO_DISCOVERY_PMLicensing = EnumTypeField(None,LM_AUTO_DISCOVERY_PMLicensingTypes, parent=self)
        self.LM_AUTO_UPDATE_PMLicensing = EnumTypeField(None,LM_AUTO_UPDATE_PMLicensingTypes, parent=self)
        self.LM_AVOTON_4CORE_PMLicensing = EnumTypeField(None,LM_AVOTON_4CORE_PMLicensingTypes, parent=self)
        self.LM_AVOTON_8CORE_PMLicensing = EnumTypeField(None,LM_AVOTON_8CORE_PMLicensingTypes, parent=self)
        self.LM_BACKUP_RESTORE_PMLicensing = EnumTypeField(None,LM_BACKUP_RESTORE_PMLicensingTypes, parent=self)
        self.LM_BASE_IPMI_GUI_PMLicensing = EnumTypeField(None,LM_BASE_IPMI_GUI_PMLicensingTypes, parent=self)
        self.LM_BASIC_REMOTE_INVENTORY_EXPORT_PMLicensing = EnumTypeField(None,LM_BASIC_REMOTE_INVENTORY_EXPORT_PMLicensingTypes, parent=self)
        self.LM_BMC_PLUS_PMLicensing = EnumTypeField(None,LM_BMC_PLUS_PMLicensingTypes, parent=self)
        self.LM_BOOT_CAPTURE_PMLicensing = EnumTypeField(None,LM_BOOT_CAPTURE_PMLicensingTypes, parent=self)
        self.LM_CONNECTION_VIEW_PMLicensing = EnumTypeField(None,LM_CONNECTION_VIEW_PMLicensingTypes, parent=self)
        self.LM_CONSOLE_COLLABORATION_PMLicensing = EnumTypeField(None,LM_CONSOLE_COLLABORATION_PMLicensingTypes, parent=self)
        self.LM_DCS_GUI_PMLicensing = EnumTypeField(None,LM_DCS_GUI_PMLicensingTypes, parent=self)
        self.LM_DEDICATED_NIC_PMLicensing = EnumTypeField(None,LM_DEDICATED_NIC_PMLicensingTypes, parent=self)
        self.LM_DEVICE_MONITORING_PMLicensing = EnumTypeField(None,LM_DEVICE_MONITORING_PMLicensingTypes, parent=self)
        self.LM_DHCP_CONFIGURE_PMLicensing = EnumTypeField(None,LM_DHCP_CONFIGURE_PMLicensingTypes, parent=self)
        self.LM_DIRECTORY_SERVICES_PMLicensing = EnumTypeField(None,LM_DIRECTORY_SERVICES_PMLicensingTypes, parent=self)
        self.LM_DYNAMIC_DNS_PMLicensing = EnumTypeField(None,LM_DYNAMIC_DNS_PMLicensingTypes, parent=self)
        self.LM_EMAIL_ALERTING_PMLicensing = EnumTypeField(None,LM_EMAIL_ALERTING_PMLicensingTypes, parent=self)
        self.LM_FULL_UI_PMLicensing = EnumTypeField(None,LM_FULL_UI_PMLicensingTypes, parent=self)
        self.LM_GROUP_MANAGER_PMLicensing = EnumTypeField(None,LM_GROUP_MANAGER_PMLicensingTypes, parent=self)
        self.LM_IDRAC_ENTERPRISE_PMLicensing = EnumTypeField(None,LM_IDRAC_ENTERPRISE_PMLicensingTypes, parent=self)
        self.LM_IDRAC_EXPRESS_BLADES_PMLicensing = EnumTypeField(None,LM_IDRAC_EXPRESS_BLADES_PMLicensingTypes, parent=self)
        self.LM_IDRAC_EXPRESS_PMLicensing = EnumTypeField(None,LM_IDRAC_EXPRESS_PMLicensingTypes, parent=self)
        self.LM_INBAND_FIRMWARE_UPDATE_PMLicensing = EnumTypeField(None,LM_INBAND_FIRMWARE_UPDATE_PMLicensingTypes, parent=self)
        self.LM_IPV6_PMLicensing = EnumTypeField(None,LM_IPV6_PMLicensingTypes, parent=self)
        self.LM_LAST_CRASH_SCREEN_CAPTURE_PMLicensing = EnumTypeField(None,LM_LAST_CRASH_SCREEN_CAPTURE_PMLicensingTypes, parent=self)
        self.LM_LAST_CRASH_VIDEO_CAPTURE_PMLicensing = EnumTypeField(None,LM_LAST_CRASH_VIDEO_CAPTURE_PMLicensingTypes, parent=self)
        self.LM_LC_UI_PMLicensing = EnumTypeField(None,LM_LC_UI_PMLicensingTypes, parent=self)
        self.LM_LICENSE_UI_PMLicensing = EnumTypeField(None,LM_LICENSE_UI_PMLicensingTypes, parent=self)
        self.LM_LOCKDOWN_MODE_PMLicensing = EnumTypeField(None,LM_LOCKDOWN_MODE_PMLicensingTypes, parent=self)
        self.LM_NTP_PMLicensing = EnumTypeField(None,LM_NTP_PMLicensingTypes, parent=self)
        self.LM_OME_PMLicensing = EnumTypeField(None,LM_OME_PMLicensingTypes, parent=self)
        self.LM_OOB_PMLicensing = EnumTypeField(None,LM_OOB_PMLicensingTypes, parent=self)
        self.LM_PART_REPLACEMENT_PMLicensing = EnumTypeField(None,LM_PART_REPLACEMENT_PMLicensingTypes, parent=self)
        self.LM_POWER_BUDGETING_PMLicensing = EnumTypeField(None,LM_POWER_BUDGETING_PMLicensingTypes, parent=self)
        self.LM_POWER_MONITORING_PMLicensing = EnumTypeField(None,LM_POWER_MONITORING_PMLicensingTypes, parent=self)
        self.LM_QUALITY_BANDWIDTH_CONTROL_PMLicensing = EnumTypeField(None,LM_QUALITY_BANDWIDTH_CONTROL_PMLicensingTypes, parent=self)
        self.LM_RACADM_CLI_PMLicensing = EnumTypeField(None,LM_RACADM_CLI_PMLicensingTypes, parent=self)
        self.LM_REDFISH_PMLicensing = EnumTypeField(None,LM_REDFISH_PMLicensingTypes, parent=self)
        self.LM_REMOTE_ASSET_INVENTORY_PMLicensing = EnumTypeField(None,LM_REMOTE_ASSET_INVENTORY_PMLicensingTypes, parent=self)
        self.LM_REMOTE_CONFIGURATION_PMLicensing = EnumTypeField(None,LM_REMOTE_CONFIGURATION_PMLicensingTypes, parent=self)
        self.LM_REMOTE_FILE_SHARE_PMLicensing = EnumTypeField(None,LM_REMOTE_FILE_SHARE_PMLicensingTypes, parent=self)
        self.LM_REMOTE_FIRWARE_UPDATE_PMLicensing = EnumTypeField(None,LM_REMOTE_FIRWARE_UPDATE_PMLicensingTypes, parent=self)
        self.LM_REMOTE_OS_DEPLOYMENT_PMLicensing = EnumTypeField(None,LM_REMOTE_OS_DEPLOYMENT_PMLicensingTypes, parent=self)
        self.LM_REMOTE_SYSLOG_PMLicensing = EnumTypeField(None,LM_REMOTE_SYSLOG_PMLicensingTypes, parent=self)
        self.LM_RESTORE_PMLicensing = EnumTypeField(None,LM_RESTORE_PMLicensingTypes, parent=self)
        self.LM_SECURITY_LOCKOUT_PMLicensing = EnumTypeField(None,LM_SECURITY_LOCKOUT_PMLicensingTypes, parent=self)
        self.LM_SMASH_CLP_PMLicensing = EnumTypeField(None,LM_SMASH_CLP_PMLicensingTypes, parent=self)
        self.LM_SNMP_GET_PMLicensing = EnumTypeField(None,LM_SNMP_GET_PMLicensingTypes, parent=self)
        self.LM_SSH_PK_AUTHEN_PMLicensing = EnumTypeField(None,LM_SSH_PK_AUTHEN_PMLicensingTypes, parent=self)
        self.LM_SSH_PMLicensing = EnumTypeField(None,LM_SSH_PMLicensingTypes, parent=self)
        self.LM_SSO_PMLicensing = EnumTypeField(None,LM_SSO_PMLicensingTypes, parent=self)
        self.LM_STORAGE_MONITORING_PMLicensing = EnumTypeField(None,LM_STORAGE_MONITORING_PMLicensingTypes, parent=self)
        self.LM_TELNET_PMLicensing = EnumTypeField(None,LM_TELNET_PMLicensingTypes, parent=self)
        self.LM_TWO_FACTOR_AUTHEN_PMLicensing = EnumTypeField(None,LM_TWO_FACTOR_AUTHEN_PMLicensingTypes, parent=self)
        self.LM_UPDATE_FROM_REPO_PMLicensing = EnumTypeField(None,LM_UPDATE_FROM_REPO_PMLicensingTypes, parent=self)
        self.LM_USC_ASSISTED_OS_DEPLOYEMENT_PMLicensing = EnumTypeField(None,LM_USC_ASSISTED_OS_DEPLOYEMENT_PMLicensingTypes, parent=self)
        self.LM_USC_DEVICE_CONFIGURATION_PMLicensing = EnumTypeField(None,LM_USC_DEVICE_CONFIGURATION_PMLicensingTypes, parent=self)
        self.LM_USC_EMBEDDED_DIAGNOSTICS_PMLicensing = EnumTypeField(None,LM_USC_EMBEDDED_DIAGNOSTICS_PMLicensingTypes, parent=self)
        self.LM_USC_FIRMWARE_UPDATE_PMLicensing = EnumTypeField(None,LM_USC_FIRMWARE_UPDATE_PMLicensingTypes, parent=self)
        self.LM_VCONSOLE_CHAT_PMLicensing = EnumTypeField(None,LM_VCONSOLE_CHAT_PMLicensingTypes, parent=self)
        self.LM_VCONSOLE_HTML5_ACCESS_PMLicensing = EnumTypeField(None,LM_VCONSOLE_HTML5_ACCESS_PMLicensingTypes, parent=self)
        self.LM_VCONSOLE_PMLicensing = EnumTypeField(None,LM_VCONSOLE_PMLicensingTypes, parent=self)
        self.LM_VFOLDER_PMLicensing = EnumTypeField(None,LM_VFOLDER_PMLicensingTypes, parent=self)
        self.LM_VIRTUAL_FLASH_PARTITIONS_PMLicensing = EnumTypeField(None,LM_VIRTUAL_FLASH_PARTITIONS_PMLicensingTypes, parent=self)
        self.LM_VMEDIA_PMLicensing = EnumTypeField(None,LM_VMEDIA_PMLicensingTypes, parent=self)
        self.LM_VNC_PMLicensing = EnumTypeField(None,LM_VNC_PMLicensingTypes, parent=self)
        self.LM_WSMAN_PMLicensing = EnumTypeField(None,LM_WSMAN_PMLicensingTypes, parent=self)
        ...
        # readonly attribute populated by iDRAC
        self.MessageArg1_1_FWUpdateTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        self.MessageArg1_1_ProfileTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        self.MessageArg1_2_FWUpdateTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        self.MessageArg1_2_ProfileTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        self.MessageArg1_3_FWUpdateTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        self.MessageArg1_3_ProfileTask = StringField(None, parent=self, modifyAllowed = False, deleteAllowed = False)
        # readonly attribute populated by iDRAC
        ...
        self.OsIpAddress_OS_BMC = StringField(None, parent=self)
        ...
        # readonly attribute populated by iDRAC
        self.PTCapability_OS_BMC = EnumTypeField(None,PTCapability_OS_BMCTypes, parent=self, modifyAllowed = False, deleteAllowed = False)
        self.PTMode_OS_BMC = EnumTypeField(None,PTMode_OS_BMCTypes, parent=self)
        ...
        self.PrefixLength_OS_BMC = IntField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.SCFWUpdateState_SC_BMC = EnumTypeField(None,SCFWUpdateState_SC_BMCTypes, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.TaskID_SC_BMC = IntField(None, parent=self)
        # readonly attribute populated by iDRAC
        ...
        self.UsbNicIpAddress_OS_BMC = StringField(None, parent=self)
